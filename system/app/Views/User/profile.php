			...
			<div class="col-md-4 col-xl-3">
				<div class="card mb-3">
					...
					<div class="card-body text-center">
						<img src="<?= $_SESSION['userData']['img']?>" alt="<?= $_SESSION['userData']['nombre']?>"
							class="rounded-circle img-responsive mt-2" width="128" height="128" />
						<h5 class="card-title mb-0"><?= $_SESSION['userData']['nombre']?></h5>
					...
					<hr class="my-0" />
					<div class="card-body">
						<h5 class="h6 card-title">Acerca</h5>
						<ul class="list-unstyled mb-0">
							<li class="mb-1"><span data-feather="home" class="feather-sm me-1"></span> Vive en <span
									class="text-primary">San Felipe, Yaracuy</span></li>

							<li class="mb-1"><span data-feather="briefcase" class="feather-sm me-1"></span> Trabaja en <span
									class="text-primary">Casa</span></li>
						</ul>
					</div>
					<hr class="my-0" />
					<div class="card-body">
					...
					<div class="card-body h-100">
						...
						<div class="d-flex align-items-start">
							...
							<div class="flex-grow-1">
								...
								<strong>Vanessa Tucker</strong> started following <strong><?= $_SESSION['userData']['nombre']?></strong><br />
						...
						<div class="d-flex align-items-start">
							...
							<div class="flex-grow-1">
								...
								<strong>Charles Hall</strong> posted something on <strong><?= $_SESSION['userData']['nombre']?></strong>'s timeline
								<br />
								...
								<a href="#" class="btn btn-sm btn-danger mt-1"><i class="feather-sm" data-feather="heart"></i>
									Like</a>
							</div>
						</div>
						...
						<div class="d-flex align-items-start">
							<img src="img/avatars/avatar-4.jpg" width="36" height="36" class="rounded-circle me-2"
								alt="<?= $_SESSION['userData']['nombre']?>">
							<div class="flex-grow-1">
								<small class="float-end text-navy">1h ago</small>
								<strong><?= $_SESSION['userData']['nombre']?></strong> posted a new blog<br />
						...
						<div class="d-flex align-items-start">
							...
							<div class="flex-grow-1">
								...
								<strong>William Harris</strong> posted two photos on <strong><?= $_SESSION['userData']['nombre']?></strong>'s timeline
								<br />
						...
						<div class="d-flex align-items-start">
							...
							<div class="flex-grow-1">
								...
								<strong>William Harris</strong> started following <strong><?= $_SESSION['userData']['nombre']?></strong><br />
						...
						<div class="d-flex align-items-start">
							...
							<div class="flex-grow-1">
								<small class="float-end text-navy">1d ago</small>
								<strong>Charles Hall</strong> started following <strong><?= $_SESSION['userData']['nombre']?></strong><br />
						...
						<div class="d-grid">
							<a href="#" class="btn btn-primary">Sin actividad</a>
						</div>
					</div>
				</div>
			</div>
