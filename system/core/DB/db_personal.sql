...
--
-- Table structure for table `table_seguridad`
--

DROP TABLE IF EXISTS `table_seguridad`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `table_seguridad` (
  `user_id` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `p1` text COLLATE utf8_spanish_ci,
  `r1` text COLLATE utf8_spanish_ci,
  `p2` text COLLATE utf8_spanish_ci,
  `p3` text COLLATE utf8_spanish_ci,
  `r2` text COLLATE utf8_spanish_ci,
  `r3` text COLLATE utf8_spanish_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `table_seguridad`
--

LOCK TABLES `table_seguridad` WRITE;
/*!40000 ALTER TABLE `table_seguridad` DISABLE KEYS */;
/*!40000 ALTER TABLE `table_seguridad` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-04-19 20:22:58
