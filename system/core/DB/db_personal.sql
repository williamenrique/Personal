...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-05-2021 a las 01:29:31
...
--
-- Estructura de tabla para la tabla `table_block`
--
...
--
-- Volcado de datos para la tabla `table_block`
--

INSERT INTO `table_block` (`user_id`, `intentos`, `token`) VALUES
('1', 0, '0');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `table_calendario`
--
...
CREATE TABLE `table_calendario` (
  ...
  `textColor` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `table_calendario`
--

INSERT INTO `table_calendario` (`id`, `title`, `description`, `color`, `textColor`, `start`, `end`, `user_id`, `status`) VALUES
(1, 'NUEVO', '', '#435ebe', '#ffffff', '2021-05-14 00:00:00', '0000-00-00 00:00:00', 1, 1),
(2, 'NUEVO', 'Descripcion', '#435ebe', '#ffffff', '2021-05-27 19:07:17', '0000-00-00 00:00:00', 1, 1),
(3, 'NUEVO', 'Descripcion', '#435ebe', '#ffffff', '2021-05-27 19:07:17', '0000-00-00 00:00:00', 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `table_ciudades`
--
...
--
-- Volcado de datos para la tabla `table_ciudades`
--

INSERT INTO `table_ciudades` (`id_ciudad`, `id_estado`, `ciudad`, `capital`) VALUES
(1, 1, 'Maroa', 0),
...
--
-- Estructura de tabla para la tabla `table_cuenta`
--
...
CREATE TABLE `table_cuenta` (
  ...
  `tipoC` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `table_estados`
--
...
--
-- Volcado de datos para la tabla `table_estados`
--

INSERT INTO `table_estados` (`id_estado`, `estado`, `iso_3166-2`) VALUES
(1, 'Amazonas', 'VE-X'),
(2, 'Anzoátegui', 'VE-B'),
(3, 'Apure', 'VE-C'),
(4, 'Aragua', 'VE-D'),
...
--
-- Estructura de tabla para la tabla `table_municipios`
--
...
--
-- Estructura de tabla para la tabla `table_seguridad`
--

CREATE TABLE `table_seguridad` (
  `user_id` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `p1` text COLLATE utf8_spanish_ci DEFAULT NULL,
  `r1` text COLLATE utf8_spanish_ci DEFAULT NULL,
  `p2` text COLLATE utf8_spanish_ci DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `table_seguridad`
--

INSERT INTO `table_seguridad` (`user_id`, `p1`, `r1`, `p2`, `p3`, `r2`, `r3`) VALUES
('1', NULL, '', NULL, NULL, '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `table_sitio`
--
...
INSERT INTO `table_user` (`user_id`, `ci`, `user`, `email`, `pass`, `nombre`, `apellido`, `img`, `ruta`, `telefono`, `direccion`, `estado`, `ciudad`, `codPostal`, `codigo`, `rol`, `status`, `fecha_reg`) VALUES
(1, 14607920, NULL, 'william21enrique@gmail.com', 'S3ZGcGh5S3VmOU1sR1UwZGRNbFI0Zz09', 'WILLIAM ENRIQUE', NULL, 'http://personal.lat/src/img/default.png', 'system/app/Views/Docs/1-WI920/', NULL, NULL, NULL, NULL, NULL, '1-WI920', NULL, 1, '2021-05-23 23:00:53');
...
--
-- Indices de la tabla `table_calendario`
--
ALTER TABLE `table_calendario`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `table_ciudades`
--
ALTER TABLE `table_ciudades`
  ADD PRIMARY KEY (`id_ciudad`),
  ADD KEY `id_estado` (`id_estado`);

--
-- Indices de la tabla `table_cuenta`
--
ALTER TABLE `table_cuenta`
  ADD PRIMARY KEY (`idCuenta`);

--
-- Indices de la tabla `table_estados`
--
ALTER TABLE `table_estados`
  ADD PRIMARY KEY (`id_estado`);

--
-- Indices de la tabla `table_municipios`
--
ALTER TABLE `table_municipios`
  ADD PRIMARY KEY (`id_municipio`),
  ADD KEY `id_ciudad` (`id_ciudad`);

--
-- Indices de la tabla `table_sitio`
--
ALTER TABLE `table_sitio`
