...
function paginator(config) {
    ...
    // console.log(config.rows_per_page);
    ...
    if (typeof config.box_mode == "function") {
        ...
        var page_box = document.createElement(config.box_mode == "list" ? "ul" : "nav");
        if (config.box_mode == "list") {
    ...
    if (!(typeof config.page_options == "boolean" && !config.page_options)) {
        ...
        var boxSelect = document.createElement("boxSelect")
        var select = document.createElement("select");
        select.classList.add('form-select');
        select.classList.add('w-1');
    ...
    stat.innerHTML = "On page " + page + " of " + pages +
        ...
        " of " + trs.length;
    // stat.innerHTML = " Pagina " + page + " de " + pages;
    console.log('largo' + page);
